                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <form action="UserServlet" method="POST" id="addUserForm" enctype="multipart/form-data">
                                            <div class="mb-3">
                                                <label for="name" class="form-label">First Name</label>
                                                <input type="text" id="name" class="form-control" name="fullName" placeholder="User fullName">
                                            </div>
